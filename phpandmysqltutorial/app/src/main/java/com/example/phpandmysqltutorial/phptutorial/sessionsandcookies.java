...
public class sessionsandcookies extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sessionsandcookies);
        // toolbar
        @SuppressLint({"MissingInflatedId", "LocalSuppress"})
        Toolbar mqtoolbar = (Toolbar) findViewById(R.id.too9);
